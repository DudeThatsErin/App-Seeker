...
- Things 3 has more shortcuts that can be used. Similar to [[Digital Gardens/Tools/Task Managers/Apple Reminders\|Apple Reminders]].
- Uses the [GTD](https://gettingthingsdone.com/) methodology so if you follow that, it would work perfect for your needs.
## Cons
- Only works on Apple devices. There isn't even a web interface to add tasks like [[Digital Gardens/Tools/Task Managers/Apple Reminders\|Apple Reminders]].
...
Things 3 is $9.99 on iPhone, $19.99 on iPad, and $49.99 on MacOS. If you have all 3 devices it is $80.00. This is a hefty price though it is a price you pay **one time**. So it is a lot easier to swallow a one time payment versus a subscription. Since I only have an iPad & iPhone it was only $30 for me which is a lot easier to swallow than $48/year for [[Digital Gardens/Tools/Task Managers/Todoist\|Todoist]], for example.

# My Conclusion

I believe Things 3 is well worth the price. It has a ton of features, it is a one time price, and it doesn’t have any features you don’t need. After using Todoist, Apple Reminders, & Things 3, I have decided to use XXXX.
# Other Reviews
## Articles
